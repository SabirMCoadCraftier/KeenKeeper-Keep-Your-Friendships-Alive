...
export default function Timeline() {
  ...
  useEffect(() => {
    ...
    if (saved.length > 0) {
      setAllEvents([...saved, ...defaultEvents]);
    }
  }, []);
          ...
          <div>
            ...
            <div className="relative inline-block w-48">
              <select 
                ...
                className="w-full h-11 bg-white border border-gray-100 rounded-xl px-4 text-xs font-semibold text-gray-500 appearance-none shadow-sm cursor-pointer hover:border-gray-200 transition-colors"
              >
